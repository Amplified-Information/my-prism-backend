...
CREATE TABLE public.positions (
    ...
    CONSTRAINT positions_cost_accum_no_usd_check CHECK ((cost_accum_no_usd >= (0.0)::double precision)),
    CONSTRAINT positions_cost_accum_yes_usd_check CHECK ((cost_accum_yes_usd >= (0.0)::double precision)),
